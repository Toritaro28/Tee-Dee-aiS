...
public:
    Admin() : ContentStorage() {
        ...
        if (genreCount == 0) {
			...
			strcpy(genres[4], "Hip-Hop");
			strcpy(genres[5], "Classical");
			strcpy(genres[6], "R&B");
			strcpy(genres[7], "Electronic");
        }
        if (languageCount == 0) {
            languageCount = 6;
            strcpy(languages[0], "English");
            strcpy(languages[1], "Chinese");
            strcpy(languages[2], "Korean");
			strcpy(languages[3], "Japanese");
			strcpy(languages[4], "Malay");
			strcpy(languages[5], "Russian");
        }
    ...
    void addDefaultRecommendedSongs() {
        ...
        Song song3;
		strcpy(song3.songName, "Fly Me to the Moon");
		strcpy(song3.artist, "Frank Sinatra");
		strcpy(song3.genre, "Jazz");
		strcpy(song3.language, "English");
		song3.favoriteCount = 0;
		recommendedSongs[recommendedSongCount++] = song3;
		
		Song song4;
		strcpy(song4.songName, "Lose Yourself");
		strcpy(song4.artist, "Eminem");
		strcpy(song4.genre, "Hip-Hop");
		strcpy(song4.language, "English");
		song4.favoriteCount = 0;
		recommendedSongs[recommendedSongCount++] = song4;
		
		Song song5;
		strcpy(song5.songName, "Fur Elise");
		strcpy(song5.artist, "Beethoven");
		strcpy(song5.genre, "Classical");
		strcpy(song5.language, "N/A");
		song5.favoriteCount = 0;
		recommendedSongs[recommendedSongCount++] = song5;
		
		Song song6;
		strcpy(song6.songName, "Blinding Lights");
		strcpy(song6.artist, "The Weeknd");
		strcpy(song6.genre, "R&B");
		strcpy(song6.language, "English");
		song6.favoriteCount = 0;
		recommendedSongs[recommendedSongCount++] = song6;
		
		Song song7;
		strcpy(song7.songName, "Strobe");
		strcpy(song7.artist, "Deadmau5");
		strcpy(song7.genre, "Electronic");
		strcpy(song7.language, "English");
		song7.favoriteCount = 0;
		recommendedSongs[recommendedSongCount++] = song7;
		
		Song song8;
		strcpy(song8.songName, "Dynamite");
		strcpy(song8.artist, "BTS");
		strcpy(song8.genre, "Pop");
		strcpy(song8.language, "Korean");
		song8.favoriteCount = 0;
		recommendedSongs[recommendedSongCount++] = song8;
		
		Song song9;
		strcpy(song9.songName, "Lemon");
		strcpy(song9.artist, "Kenshi Yonezu");
		strcpy(song9.genre, "Pop");
		strcpy(song9.language, "Japanese");
		song9.favoriteCount = 0;
		recommendedSongs[recommendedSongCount++] = song9;
		
		Song song10;
		strcpy(song10.songName, "Cindai");
		strcpy(song10.artist, "Siti Nurhaliza");
		strcpy(song10.genre, "Pop");
		strcpy(song10.language, "Malay");
		song10.favoriteCount = 0;
		recommendedSongs[recommendedSongCount++] = song10;
		
		Song song11;
		strcpy(song11.songName, "Gruppa Krovi");
		strcpy(song11.artist, "Kino");
		strcpy(song11.genre, "Rock");
		strcpy(song11.language, "Russian");
		song11.favoriteCount = 0;
		recommendedSongs[recommendedSongCount++] = song11;
		
		Song song12;
		strcpy(song12.songName, "Shape of You");
		strcpy(song12.artist, "Ed Sheeran");
		strcpy(song12.genre, "Pop");
		strcpy(song12.language, "English");
		song12.favoriteCount = 0;
		recommendedSongs[recommendedSongCount++] = song12;
        saveRecommendedSongs();
    }
    ...
    void addDefaultPurchasableAlbums() {
		...
		Album album3;
		strcpy(album3.albumName, "A Night at the Opera");
		strcpy(album3.artist, "Queen");
		strcpy(album3.genre, "Rock");
		strcpy(album3.language, "English");
		album3.price = 14.99;
		album3.soldCount = 0;
		Song s3_1; strcpy(s3_1.songName, "Bohemian Rhapsody"); strcpy(s3_1.artist, "Queen"); strcpy(s3_1.genre, "Rock"); strcpy(s3_1.language, "English"); s3_1.favoriteCount=0;
		Song s3_2; strcpy(s3_2.songName, "You're My Best Friend"); strcpy(s3_2.artist, "Queen"); strcpy(s3_2.genre, "Rock"); strcpy(s3_2.language, "English"); s3_2.favoriteCount=0;
		album3.songs[album3.songCount++] = s3_1;
		album3.songs[album3.songCount++] = s3_2;
		purchasableAlbums[purchasableAlbumCount++] = album3;
		
		Album album4;
		strcpy(album4.albumName, "Random Access Memories");
		strcpy(album4.artist, "Daft Punk");
		strcpy(album4.genre, "Electronic");
		strcpy(album4.language, "English");
		album4.price = 18.99;
		album4.soldCount = 0;
		Song s4_1; strcpy(s4_1.songName, "Get Lucky"); strcpy(s4_1.artist, "Daft Punk"); strcpy(s4_1.genre, "Electronic"); strcpy(s4_1.language, "English"); s4_1.favoriteCount=0;
		Song s4_2; strcpy(s4_2.songName, "Instant Crush"); strcpy(s4_2.artist, "Daft Punk"); strcpy(s4_2.genre, "Electronic"); strcpy(s4_2.language, "English"); s4_2.favoriteCount=0;
		album4.songs[album4.songCount++] = s4_1;
		album4.songs[album4.songCount++] = s4_2;
		purchasableAlbums[purchasableAlbumCount++] = album4;
		
		Album album5;
		strcpy(album5.albumName, "To Pimp a Butterfly");
		strcpy(album5.artist, "Kendrick Lamar");
		strcpy(album5.genre, "Hip-Hop");
		strcpy(album5.language, "English");
		album5.price = 16.50;
		album5.soldCount = 0;
		Song s5_1; strcpy(s5_1.songName, "Alright"); strcpy(s5_1.artist, "Kendrick Lamar"); strcpy(s5_1.genre, "Hip-Hop"); strcpy(s5_1.language, "English"); s5_1.favoriteCount=0;
		Song s5_2; strcpy(s5_2.songName, "King Kunta"); strcpy(s5_2.artist, "Kendrick Lamar"); strcpy(s5_2.genre, "Hip-Hop"); strcpy(s5_2.language, "English"); s5_2.favoriteCount=0;
		album5.songs[album5.songCount++] = s5_1;
		album5.songs[album5.songCount++] = s5_2;
		purchasableAlbums[purchasableAlbumCount++] = album5;
		
		Album album6;
		strcpy(album6.albumName, "Kind of Blue");
		strcpy(album6.artist, "Miles Davis");
		strcpy(album6.genre, "Jazz");
		strcpy(album6.language, "English");
		album6.price = 11.99;
		album6.soldCount = 0;
		Song s6_1; strcpy(s6_1.songName, "So What"); strcpy(s6_1.artist, "Miles Davis"); strcpy(s6_1.genre, "Jazz"); strcpy(s6_1.language, "English"); s6_1.favoriteCount=0;
		Song s6_2; strcpy(s6_2.songName, "Freddie Freeloader"); strcpy(s6_2.artist, "Miles Davis"); strcpy(s6_2.genre, "Jazz"); strcpy(s6_2.language, "English"); s6_2.favoriteCount=0;
		album6.songs[album6.songCount++] = s6_1;
		album6.songs[album6.songCount++] = s6_2;
		purchasableAlbums[purchasableAlbumCount++] = album6;
		
		Album album7;
		strcpy(album7.albumName, "Blonde");
		strcpy(album7.artist, "Frank Ocean");
		strcpy(album7.genre, "R&B");
		strcpy(album7.language, "English");
		album7.price = 17.00;
		album7.soldCount = 0;
		Song s7_1; strcpy(s7_1.songName, "Nikes"); strcpy(s7_1.artist, "Frank Ocean"); strcpy(s7_1.genre, "R&B"); strcpy(s7_1.language, "English"); s7_1.favoriteCount=0;
		Song s7_2; strcpy(s7_2.songName, "Self Control"); strcpy(s7_2.artist, "Frank Ocean"); strcpy(s7_2.genre, "R&B"); strcpy(s7_2.language, "English"); s7_2.favoriteCount=0;
		album7.songs[album7.songCount++] = s7_1;
		album7.songs[album7.songCount++] = s7_2;
		purchasableAlbums[purchasableAlbumCount++] = album7;
		
		Album album8;
		strcpy(album8.albumName, "Love Yourself: Answer");
		strcpy(album8.artist, "BTS");
		strcpy(album8.genre, "Pop");
		strcpy(album8.language, "Korean");
		album8.price = 22.50;
		album8.soldCount = 0;
		Song s8_1; strcpy(s8_1.songName, "IDOL"); strcpy(s8_1.artist, "BTS"); strcpy(s8_1.genre, "Pop"); strcpy(s8_1.language, "Korean"); s8_1.favoriteCount=0;
		Song s8_2; strcpy(s8_2.songName, "Fake Love"); strcpy(s8_2.artist, "BTS"); strcpy(s8_2.genre, "Pop"); strcpy(s8_2.language, "Korean"); s8_2.favoriteCount=0;
		album8.songs[album8.songCount++] = s8_1;
		album8.songs[album8.songCount++] = s8_2;
		purchasableAlbums[purchasableAlbumCount++] = album8;
		
		Album album9;
		strcpy(album9.albumName, "First Love");
		strcpy(album9.artist, "Hikaru Utada");
		strcpy(album9.genre, "Pop");
		strcpy(album9.language, "Japanese");
		album9.price = 19.99;
		album9.soldCount = 0;
		Song s9_1; strcpy(s9_1.songName, "First Love"); strcpy(s9_1.artist, "Hikaru Utada"); strcpy(s9_1.genre, "Pop"); strcpy(s9_1.language, "Japanese"); s9_1.favoriteCount=0;
		Song s9_2; strcpy(s9_2.songName, "Automatic"); strcpy(s9_2.artist, "Hikaru Utada"); strcpy(s9_2.genre, "Pop"); strcpy(s9_2.language, "Japanese"); s9_2.favoriteCount=0;
		album9.songs[album9.songCount++] = s9_1;
		album9.songs[album9.songCount++] = s9_2;
		purchasableAlbums[purchasableAlbumCount++] = album9;
		
		Album album10;
		strcpy(album10.albumName, "Lagu Dari Sebuah Bilik");
		strcpy(album10.artist, "Sudirman Arshad");
		strcpy(album10.genre, "Pop");
		strcpy(album10.language, "Malay");
		album10.price = 9.99;
		album10.soldCount = 0;
		Song s10_1; strcpy(s10_1.songName, "Bercanda Di Pasiran Pantai"); strcpy(s10_1.artist, "Sudirman Arshad"); strcpy(s10_1.genre, "Pop"); strcpy(s10_1.language, "Malay"); s10_1.favoriteCount=0;
		album10.songs[album10.songCount++] = s10_1;
		purchasableAlbums[purchasableAlbumCount++] = album10;
		
		Album album11;
		strcpy(album11.albumName, "The Nutcracker");
		strcpy(album11.artist, "Tchaikovsky");
		strcpy(album11.genre, "Classical");
		strcpy(album11.language, "Russian");
		album11.price = 10.50;
		album11.soldCount = 0;
		Song s11_1; strcpy(s11_1.songName, "Dance of the Sugar Plum Fairy"); strcpy(s11_1.artist, "Tchaikovsky"); strcpy(s11_1.genre, "Classical"); strcpy(s11_1.language, "Russian"); s11_1.favoriteCount=0;
		Song s11_2; strcpy(s11_2.songName, "Waltz of the Flowers"); strcpy(s11_2.artist, "Tchaikovsky"); strcpy(s11_2.genre, "Classical"); strcpy(s11_2.language, "Russian"); s11_2.favoriteCount=0;
		album11.songs[album11.songCount++] = s11_1;
		album11.songs[album11.songCount++] = s11_2;
		purchasableAlbums[purchasableAlbumCount++] = album11;
		
		Album album12;
		strcpy(album12.albumName, "21");
		strcpy(album12.artist, "Adele");
		strcpy(album12.genre, "Pop");
		strcpy(album12.language, "English");
		album12.price = 13.50;
		album12.soldCount = 0;
		Song s12_1; strcpy(s12_1.songName, "Rolling in the Deep"); strcpy(s12_1.artist, "Adele"); strcpy(s12_1.genre, "Pop"); strcpy(s12_1.language, "English"); s12_1.favoriteCount=0;
		Song s12_2; strcpy(s12_2.songName, "Someone Like You"); strcpy(s12_2.artist, "Adele"); strcpy(s12_2.genre, "Pop"); strcpy(s12_2.language, "English"); s12_2.favoriteCount=0;
		album12.songs[album12.songCount++] = s12_1;
		album12.songs[album12.songCount++] = s12_2;
		purchasableAlbums[purchasableAlbumCount++] = album12;
    ...
    void editAlbum() {
        ...
        if (choice > 0 && choice <= purchasableAlbumCount) {
            ...
            cout << "\tEnter new album price (current: RM" << fixed << setprecision(2) << albumToEdit->price << "): RM";
    ...
    void displayAllPurchasableAlbums() {
        ...
        for (int i = 0; i < purchasableAlbumCount; i++) {
            cout << "\t" << (i + 1) << ". Album: " << purchasableAlbums[i].albumName
                 ...
                 << " [" << purchasableAlbums[i].genre << ", "
                 << purchasableAlbums[i].language << "] - Price: RM"
...
void User::purchasePackage(UserLogin* userLogin, Admin* admin_ptr) {
    ...
    cout << "\n\tAvailable Packages:\n";
    cout << "\t1. 1-Month Package: RM10.00\n";
    cout << "\t2. 3-Month Package: RM25.00 (Save $5!)\n";
    cout << "\t3. Permanent Package: RM100.00\n";
...
void User::purchaseDigitalAlbum(UserLogin* userLogin, Admin* admin_ptr) {
    ...
    for (int i = 0; i < admin_ptr->getPurchasableAlbumCount(); i++) {
        cout << "\t" << (i + 1) << ". Album: " << albums[i].albumName
             << " by " << albums[i].artist
             << " - Price: RM" << fixed << setprecision(2) << albums[i].price << endl;
    }
    cout << "\t0. Back to User Menu\n";
...
int User::processPayment(const char* username_payer, const char* itemName, const char* itemType, double amount_to_pay, long long itemExpiry) {
    ...
    cout << "\t|         PAYMENT SYSTEM        |\n";
    cout << "\t|-------------------------------|\n";
    cout << "\n\tItem: " << itemName << " (" << itemType << ") - Amount: RM" << fixed << setprecision(2) << amount_to_pay << endl;
...
void generatePurchaseReport(Admin& admin_ref) {
    ...
    for (int i = 0; i < recordCount; i++) {
        ...
        cout << "\tAmount: RM" << fixed << setprecision(2) << records[i].amount << endl;
