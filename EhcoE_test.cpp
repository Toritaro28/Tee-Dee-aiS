...
public:
    ...
    int binarySearchRecommendedSong(const char* targetSongName) {
        // NOTE: Assumes array is already sorted by song name.
        int low = 0;
    ...
    void searchRecommendedSongBinary() {
        ...
        // Sort before searching to guarantee correctness
    ...
    void incrementFavoriteCount(const char* songName, const char* artist) {
        ...
        // Check the found index and linearly scan nearby for the correct artist
        // Search backwards from initial_index
        ...
        // Search forwards from initial_index + 1
...
void User::searchPlaylist() {
    ...
    do {
        ...
        // Sort playlists by name before searching
        mergeSortPlaylists(playlists, 0, playlistCount - 1);
...
void User::updatePlaylist() {
    ...
    // Sort playlists to enable binary search
    mergeSortPlaylists(playlists, 0, playlistCount - 1);
    int index = binarySearchPlaylist(playlists, playlistCount, playlistName);
    ...
    if (index != -1) {
        ...
        // Check if the new name already exists (excluding the current playlist)
        int isDuplicate = 0;
        for (int i = 0; i < playlistCount; i++) {
...
void searchPurchaseRecords(Admin& admin_ref) { // Friend Function 4
    ...
    do {
        ...
        try {
            ...
            cout << "\tAn error occurred while reading purchase records." << endl;
            if (file) fclose(file);
            cout << "\n\tPress ENTER to return..." << endl;
            _getch(); system("cls"); return;
        }
        ...
        if (index != -1) {
            ...
            // Print all records for this user
                            ...
                            while (1) {
                                ...
                                if (strcmp(proceedDecision_input, "yes") == 0) {
                                    switch (choice) {
                                        ...
                                        case 2: user.searchPlaylist(); break; // No loading page needed
                ...
                if (strcmp(decision_input, "yes") == 0) {
                    ...
                    if (adminLogin.getLoginStatus()) {
                        while (1) {
                            ...
                            cout << "\t!    13. Search Recommended Songs (Binary)  !\n";
                            cout << "\t!    14. Add Album for Sale                 !\n";
                            cout << "\t!    15. Display All Albums for Sale        !\n";
                            cout << "\t!    16. Generate Purchase Report           !\n";
                            cout << "\t!    17. Search Purchase Records            !\n";
                            cout << "\t!    18. Logout                             !\n";
                            cout << "\t!                                           !\n";
                            cout << "\t#############################################\n";
                            cout << "\n\tEnter your choice: ";
